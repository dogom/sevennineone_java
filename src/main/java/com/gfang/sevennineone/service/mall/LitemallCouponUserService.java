...
import com.gfang.sevennineone.dao.mall.LitemallCouponUserMapper;
import com.gfang.sevennineone.model.po.mall.LitemallCouponUser;
import com.gfang.sevennineone.model.po.mall.LitemallCouponUserExample;
import com.gfang.sevennineone.util.CouponUserConstant;
...
public class LitemallCouponUserService {
    ...
    public Integer countUserAndCoupon(String userId, Integer couponId) {
        LitemallCouponUserExample example = new LitemallCouponUserExample();
    ...
    public List<LitemallCouponUser> queryList(String userId, Integer couponId, Short status, Integer page, Integer size, String sort, String order) {
        LitemallCouponUserExample example = new LitemallCouponUserExample();
    ...
    public List<LitemallCouponUser> queryAll(String userId, Integer couponId) {
    ...
    public LitemallCouponUser queryOne(String userId, Integer couponId) {
