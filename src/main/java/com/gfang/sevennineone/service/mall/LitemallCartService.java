...
import com.gfang.sevennineone.dao.mall.LitemallCartMapper;
import com.gfang.sevennineone.model.po.mall.LitemallCart;
import com.gfang.sevennineone.model.po.mall.LitemallCartExample;
...
public class LitemallCartService {
    ...
    public LitemallCart queryExist(Integer goodsId, Integer productId, String userId) {
    ...
    public int delete(List<Integer> productIdList, String userId) {
        LitemallCartExample example = new LitemallCartExample();
    ...
    public int updateCheck(String userId, List<Integer> idsList, Boolean checked) {
        LitemallCartExample example = new LitemallCartExample();
    ...
    public void clearGoods(String userId) {
        LitemallCartExample example = new LitemallCartExample();
    ...
    public List<LitemallCart> querySelective(String userId, Integer goodsId, Integer page, Integer limit, String sort, String order) {
        LitemallCartExample example = new LitemallCartExample();
