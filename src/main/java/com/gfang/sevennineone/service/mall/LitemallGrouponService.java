...
import com.gfang.sevennineone.dao.mall.LitemallGrouponMapper;
import com.gfang.sevennineone.model.po.mall.LitemallGroupon;
import com.gfang.sevennineone.model.po.mall.LitemallGrouponExample;
...
public class LitemallGrouponService {
     ...
     * @return
     */
    public List<LitemallGroupon> queryMyGroupon(String userId) {
     ...
     * @return
     */
    public List<LitemallGroupon> queryMyJoinGroupon(String userId) {
        LitemallGrouponExample example = new LitemallGrouponExample();
