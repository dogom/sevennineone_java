...
import com.gfang.sevennineone.dao.mall.LitemallOrderMapper;
import com.gfang.sevennineone.dao.mall.OrderMapper;
import com.gfang.sevennineone.model.po.mall.LitemallOrder;
import com.gfang.sevennineone.model.po.mall.LitemallOrderExample;
import com.gfang.sevennineone.util.OrderUtil;
...
public class LitemallOrderService {
    ...
    public int countByOrderSn(String userId, String orderSn) {
        LitemallOrderExample example = new LitemallOrderExample();
    ...
    public List<LitemallOrder> queryByOrderStatus(String userId, List<Short> orderStatus, Integer page, Integer limit, String sort, String order) {
        LitemallOrderExample example = new LitemallOrderExample();
    ...
    public List<LitemallOrder> querySelective(String userId, String orderSn, List<Short> orderStatusArray, Integer page, Integer limit, String sort, String order) {
        LitemallOrderExample example = new LitemallOrderExample();
    ...
    public Map<Object, Object> orderInfo(String userId) {
        LitemallOrderExample example = new LitemallOrderExample();
        example.or().andUserIdEqualTo(userId).andDeletedEqualTo(false);
