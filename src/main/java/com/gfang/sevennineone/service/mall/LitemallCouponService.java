...
import com.gfang.sevennineone.dao.mall.LitemallCouponMapper;
import com.gfang.sevennineone.dao.mall.LitemallCouponUserMapper;
import com.gfang.sevennineone.model.po.mall.LitemallCoupon;
import com.gfang.sevennineone.model.po.mall.LitemallCouponExample;
...
import com.gfang.sevennineone.util.CouponConstant;
import com.github.pagehelper.PageHelper;
import com.gfang.sevennineone.model.po.mall.LitemallCoupon.Column;
...
public class LitemallCouponService {
    ...
    public List<LitemallCoupon> queryAvailableList(String userId, int offset, int limit) {
        assert userId != null;
        // 过滤掉登录账号已经领取过的coupon
