...
import com.gfang.sevennineone.dao.mall.LitemallAddressMapper;
import com.gfang.sevennineone.model.po.mall.LitemallAddress;
import com.gfang.sevennineone.model.po.mall.LitemallAddressExample;
...
public class LitemallAddressService {
    ...
    public List<LitemallAddress> queryByUid(String uid) {
        LitemallAddressExample example = new LitemallAddressExample();
        example.or().andUserIdEqualTo(uid).andDeletedEqualTo(false);
        return addressMapper.selectByExample(example);
    }

    public LitemallAddress query(String userId, Integer id) {
        LitemallAddressExample example = new LitemallAddressExample();
