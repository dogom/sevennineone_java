...
import com.gfang.sevennineone.model.po.mall.LitemallCategory;
import com.gfang.sevennineone.model.po.mall.LitemallGoods;
...
public class WxHomeController {
    ...
    public Object index(@LoginUser SnoUserPO user) {
        ...
        if(user == null){
            ...
            couponListCallable = () -> couponService.queryAvailableList(user.getId(),0, 3);
        }
